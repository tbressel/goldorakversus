...
Texte_Credits
	DEFM " 'CROCORAK' EST UN JEU AMSTRAD GX4000.  "		; ligne 1
	DEFM "                                        "
	DEFM "                                        "
	...
	DEFM "----------------------------------------"		; ligne 13
	DEFM "                                        "
	DEFM "     CROCOFEST, 25 & 26 MARS 2023       "
	DEFM "                                        "
	DEFM " MERCI A JEREMIE MARSIN (RETROREDRUM)   "		; ligne 17
	DEFM "POUR L'ORGANISATION DE CETTE CONVENTION "		; ligne 18
	DEFM "AUTOUR DE NOS CHERS MICRO-ORDINATEURS ! "
	DEFM "                                        "
	DEFM "JE SUIS CONTENT DE VOUS PRESENTER CETTE "
	DEFM "VERSION EXCLUSIVE DE GOLDORAK POUR CE   "
	DEFM "1ER CROCOFEST !                         "
	DEFM "                         ZISQUIER       "
	DEFM "                                        "
