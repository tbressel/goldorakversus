C:
cd C:\Users\Utilisateur\Documents\CROCOrackGX\
rasm_w32 contenu_cartouche\maptiles\goldospace.asm -ob contenu_cartouche\maptiles\goldospace.prg
...
C:\Users\Utilisateur\Documents\CROCOrackGX\WinAPE20B2\WinApe.exe  /sym:goldogx.sym goldogx.cpr
cmd
